        ...
        <Dialog
          ...
          />
            ...
            <div className="flex self-center justify-center fixed inset-0 p-4">
                ...
                <ul className="flex flex-nowrap gap-5 overflow-x-auto hide-scrollbar mt-5">
                ...
                <h3 className="font-bold text-left mt-5 text-2xl text-white">Your Watched list</h3>
                <section className="profile-contents">
 
                   <ul className="flex gap-5 overflow-x-auto hide-scrollbar mt-5">
